...
export default function ActionFlow({
  ...
  function submitRound(event) {
    ...
    const generatedCard = generateCard(mode, normalized);
    const nextRound = {
      ...
      minimumRequest:
        mode === "person" ? normalized.minimumRequest : undefined,
      minimumPublishVersion:
        mode === "publish" ? normalized.minimumPublishVersion : undefined,
      minimumOfflineVersion:
        mode === "offline" ? normalized.minimumOfflineVersion : undefined,
      generatedCard,
      resultStatus: null,
      notDoneReason: "",
      downgradedAction: "",
            ...
            <div className="generatedArea">
              ...
              {round.resultStatus === "done" ? (
                ...
                <div className="resultButtons">
                  ...
                  <button className="secondaryButton" onClick={handleDowngrade}>
                    没做，帮我降级
                  </button>
                </div>
              )}
